...
function Get-DomainInfo($DomainName)
    ...
    Write-Host "Forest Functional Level: " -NoNewline
    ...
    switch ($ffl)
    
        {
            ...
            Windows2016 { Write-Host -ForegroundColor green "Windows Server 2016" }
            Windows2019 { Write-Host -ForegroundColor green "Windows Server 2019" }
    ...
    Write-Host "Tombstone lifetime: " -NoNewline
    ...
    Write-Host "Active Directory Recycle Bin: " -NoNewline
    ...
    Write-Host "Domains in this forest: " -NoNewline
    ...
    # Trusts enumeration
    Write-Host "List of trusts: " -NoNewline
